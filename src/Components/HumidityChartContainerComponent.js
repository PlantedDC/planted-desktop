...
import {connect} from 'react-redux';
 ...
 const draw = (data) => {
        ...
        //var parseTime = d3.timeParse("%a %B %d 20%y %H:%M:%S");
        // set the ranges
        ...
        data.forEach(function(d) {
            ...
            console.log('humidity ' + d.humidity + ' :times ' + d.created);
        });
...
class HumidityChartContainerComponent extends Component {
...
export default connect(mapStateToProps)(HumidityChartContainerComponent);
